        ...
        <div className="mt-20 bg-gray-200 min-h-[1100px]">
          ...
          <div className="mx-[27%] w-[50%] h-[800px] rounded-2xl shadow-2xl bg-white">
            <div className="mx-[10%] mt-10">
              <div>
                <label className="font-light mt-10" htmlFor="selectOption">
                  Field
                </label>
                <Select
                  options={swapform}
              ...
              <div className="mt-5">
                {selectedOption.value === "sekolah" && (
                  <>
                    <form>
                      <div className="mt-5">
                        <label className="font-light" htmlFor="selectOption">
                          Skill (main)
                        </label>
                        <Select
                      ...
                      <div className="mt-5">
                        <label className="font-light" htmlFor="selectOption">
                          Alternative 2 (if main not exist)
                        </label>
                        <Select
