  ...
  return (
    <>
      ...
      {cardSearch.map((card, index) => (
        <div
          key={index}
          className="flex flex-col items-center my-10 mx-[300px]"
        >
          <div className="bg-white w-[90%] min-w-[1100px] shadow-xl rounded-xl border-2 flex flex-col items-center">
            ...
            <div className="flex flex-row justify-center items-center mr-[20%] w-[90%] h-[250px]">
              ...
              <div className="text-left ml-4">
                ...
                <h5 className="mb-1 text-[15px] font-normal">{card.age}</h5>
                <h5 className="mb-1 text-[15px] font-normal">{card.title}</h5>
              </div>
            </div>
            ...
            <span className="mt-3 flex items-center font-bold mr-[20%]">
              <p className="mr-20 text-xl">{card.twotitle}</p>
              <p className="ml-20 bg-[#fceab3]">{card.rating}</p>
              <p className="ml-20 bg-[#fceab3]">{card.rating2}</p>
            </span>
