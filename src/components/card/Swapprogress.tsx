                ...
                <div className="flex flex-col w-[50%] justify-center items-center border-r-4">
                  ...
                  <div className="flex flex-col justify-center items-center">
                    ...
                    <p className="text-slate-400">
                      Economy, Biology, Math, Gaming, Design Grapic
                    </p>
                  </div>
                  <div className="flex flex-col justify-center w-[130%] text-justify items-center pt-[100px]">
                    <h1 className="flex items-start text-xl font-bold pr-[70%]">
                      Description teach
                    </h1>
                    <p className="pt-3 pr-20">
                      Disini dijelaskan bagaimana memiliki kemandirian
                      (independent thinking). Rahasia kenapa memiliki keyakinan
                      tinggi bisa membuat seorang investor bersabar saat harga
                      turun. Dijelaskan alasan LKH mengapa tidak melakukan
                      diversifikasi saham dan bagaimana sikap LKH mengatur
                      keuangannya saat melihat peluang saham mercy dijual harga
                      bajaj. Dijelaskan kenapa strategi diversifikasi akan sulit
                      menjadi super rich. Dijelaskan apa itu analisa teknikal
                      dan analisa fundamental dan mengapa LKH bilang analisa
                      teknikal tidak bisa kaya. Apa itu bedanya trading dan
                      investasi. Simulasi trader aktif dengan pialang mana yang
                      lebih kaya
                    </p>
                  </div>
                  <div className="flex justify-center items-center pt-5">
                    <div className="mr-[100px]">
                      ...
                      <label className="pl-2">Already Teach</label>
                    </div>
                    <div>
                      <input type="checkbox" name="courseOption" />
                      <label className="pl-5">Already got Teach</label>
                    </div>
                  </div>
